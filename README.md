...
176 completed runs stored under `results/<model>/<scenario>-<sfid>-<hash>/`. Each run directory contains `results.RDS` (parsed `teems` output) and `model_diagnostics.txt`.
